...
process SampleRunMultiQC {
  ...
  mkdir -p ignoreFolder ; find . -maxdepth 1 \\( -name 'CO_ignore*mqc.json' -o -name 'IS_*mqc.json' -o -name 'GC_ignore*mqc.json' -o -name 'ME_aware_mqc.json' \\) -type f -print0 | xargs -0r mv -t ignoreFolder
...
process CohortRunMultiQC {
  ...
  parse_alfred.py --alfredfiles *alfred*tsv.gz
  mkdir -p ignoreFolder ; find . -maxdepth 1 \\( -name 'CO_ignore_mqc.json' -o -name 'IS_*mqc.json' -o -name 'GC_ignore_mqc.json' -o -name 'ME_aware_mqc.json' \\) -type f -print0 | xargs -0r mv -t ignoreFolder
