...
if (!params.bam_pairing) {
 ...
 // GATK BaseRecalibrator , CreateRecalibrationTable
  ...
  process AggregateBamQc {
    ...
    """
    Rscript --no-init-file create-aggregate-qc-file.R ${options}
    """
  }
}
...
process SomaticAnnotateMaf {
  ...
  Rscript --no-init-file  filter-somatic-maf.R ${outputPrefix}.raw.oncokb.maf ${outputPrefix}
  """
}
...
process SomaticFacetsAnnotation {
  ...
  Rscript --no-init-file annotate-with-zygosity-somatic.R ${outputPrefix}.facets.maf ${outputPrefix}.facets.zygosity.maf
  """
}
...
process GermlineAnnotateMaf {
  ...
  Rscript --no-init-file filter-germline-maf.R ${outputPrefix}.raw.maf ${outputPrefix}
  """
  }
...
process GermlineFacetsAnnotation {
  ...
  Rscript --no-init-file annotate-with-zygosity-germline.R ${outputPrefix}.facets.maf ${outputPrefix}.facets.zygosity.maf
  """
}
