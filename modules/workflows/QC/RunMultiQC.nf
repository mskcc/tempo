process RunMultiQC {
  ...
  output:
    tuple val(idTumor), val(idNormal), file("*multiqc_report*.html"), file("*multiqc_data*.zip"), emit: multiqc_report
