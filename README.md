[![Build Status](https://travis-ci.com/mskcc/tempo.svg?branch=master)](https://travis-ci.com/mskcc/tempo)
...
For further details of how to begin processing data with Tempo, please view our [documentation](https://ccstempo.netlify.com/). For contributing to this project, please make a pull request as detailed [here](https://vaporeware.netlify.com/contributing-to-vaporware.html).
