...
For further details of how to begin processing data with Tempo, please view our [documentation](https://vaporeware.netlify.com/). For contributing to this project, please make a pull request as detailed [here](https://vaporeware.netlify.com/contributing-to-vaporware.html).
